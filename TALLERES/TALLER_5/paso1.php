...
$ciudades = ['Londres', 'Singapur', 'Sídney', 'Barcelona', 'San Francisco'];
$inicial = 'S';

function contarCiudadesPorInicial($ciudades, $inicial) {
    $contador = 0;
    foreach ($ciudades as $ciudad) {
        if (stripos($ciudad, $inicial) === 0) { //el stripos me permite evaluar la primera aparicion de una cadena 
            $contador++;
        }
    }
    return $contador;
...
echo"<br>";
echo "El Número de ciudades que comienzan con '$inicial': " . contarCiudadesPorInicial($ciudades, $inicial);
